...
include { methodsDescriptionText } from '../subworkflows/local/utils_nfcore_gms16s_pipeline'
...
*/
    ...
    ch_workflow_summary         = Channel.value(paramsSummaryMultiqc(workflow, summary_params))
    ch_methods_description      = Channel.value(methodsDescriptionText(workflow, ch_multiqc_custom_methods_description))
